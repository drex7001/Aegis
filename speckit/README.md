...
| [`specs/08-ontology-v2.md`](specs/08-ontology-v2.md) | Ontology v2 — **final** (Phase 3, narrowed by ADR-033, amended by ADR-037…040): module composition, interfaces, shared properties, actions v2 schema, change management, contracts. §0 records what T29's re-validation changed; §11 holds the machinery deferred to its first consumer. |
